...
1.  Połącz się z siecią `MyAP_Arduino` i wejdź na stronę: **`192.168.4.1
2.  Klik na przycisk `Aktualizacja systemu (OTA)`
3.  Wpisz dane logowania:
    *   **Użytkownik:** `admin`
    *   **Hasło:** `admin123`
4.  Wskaż wygenerowany plik `.bin` i kliknij **🚀 Rozpocznij instalację**.
5.  Pasek postępu wyświetli stan wgrywania. Po zakończeniu , PRZECZYTAJ I ZRÓB CO CHCESZ. ;)
